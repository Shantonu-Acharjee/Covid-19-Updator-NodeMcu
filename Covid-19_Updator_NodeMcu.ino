 ...
 */
 ...
 LiquidCrystal_I2C lcd(0x3F, 16, 2);
  ...
  const char* url1 = "/apps/thinghttp/send_request?api_key=86VCZHZG1J2OR83U"; //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=G0O38IC27JJDJIAC"; //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=KML859BCCQUAXEH2"; //Recovered
  ...
  void setup() {
    ...
    lcd.begin(16, 2);
    lcd.setCursor(3, 0);
    lcd.print("Covid-19 BD"); //Change Your Country Name
    lcd.setCursor(2, 1);
    lcd.print("ROBO DRIMEAR");  //Change Name if you want
